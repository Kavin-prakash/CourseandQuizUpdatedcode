  ...
  return (
    <>
      ...
      <Container maxWidth="md" style={{ marginTop: "2rem" }}>
        ...
        >
          {theme === "garden" ? "Your Enchanted Fairy Garden" : "Your Desert Warfield"}
        </AnimatedTypography>
        <Box 
          display="flex" 
        ...
        >
          <motion.div
            animate={theme === "garden" ? { y: [0, -10, 0] } : { y: [0, -10, 0], rotate: 360 }}
            transition={{ duration: theme === "garden" ? 5 : 10, repeat: Infinity }}
            style={{ position: 'absolute', top: '10px', right: '10px' }}
          >
            <WbSunnyIcon style={{ fontSize: theme === "garden" ? 60 : 80, color: theme === "garden" ? '#FFD700' : '#FF6347' }} />
          </motion.div>
          {theme === "garden" ? (
            [...Array(3)].map((_, index) => (
              <motion.div
                ...
                style={{ position: 'absolute', top: `${index * 15 + 5}%`, left: '5%' }}
              >
            ...
            [...Array(5)].map((_, index) => (
              ...
              >
                <LocalFloristIcon style={{ fontSize: 40, color: '#006400' }} />
              </motion.div>
            ))
          )}
          <Box 
...
function ScoreItem({ scoreItem, setActiveItem, isActive, theme }) {
      ...
      return [...Array(20)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            height: '5px',
            borderRadius: '50%',
            backgroundColor: ['#FF69B4', '#FFD700', '#FF6347', '#00CED1'][Math.floor(Math.random() * 4)],
          }}
        />
      ));
    }
  ...
  return (
    <Tooltip title={`${scoreItem.topicName}: ${scoreItem.score}/${scoreItem.passMark}`}>
      <Box 
        textAlign="center"
      ...
      >
          ...
          {theme === "garden" ? (
            <LocalFloristIcon 
              style={{ 
                ...
                color: scoreItem.score >= scoreItem.passMark ? '#FF69B4' : '#8B4513' 
              }} 
            />
          ) : (
        ...
        {scoreItem.score < scoreItem.passMark && !reattemptClicked && (
          <Button
            ...
            style={{ marginTop: '0.5rem', background: theme === "garden" ? '#4CAF50' : '#B8860B' }}
          >
