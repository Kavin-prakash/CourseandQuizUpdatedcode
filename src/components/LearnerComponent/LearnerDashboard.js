...
const LearnerDashboard = ({ enrolledCourses, loading, error, search }) => {
  ...
  return (
    <div>
      ...
      <div className='background-container_learner'>
      <div className="container-fluid ">
        <div className=" d-flex "  id = 'allcont'>
          <div className=" justify-content-center ">
            <div   id = 'profile-card'  >
              {/* <div className="position-relative"> */}
              <img src={profilePhoto} className=" rounded-circle mt-5 mx-auto" alt="Profile" style={{ width: '150px', height: '150px' }}  id='card-img-top' />
              <input
                type="file"
                accept="image/*"
                id="profile-pic-upload"
          ...
          <div className='all-card '>
            <Card id='count-card' sx={{ backgroundColor: ' #f0f0f0' }}>
              ...
              {/* <CardMedia className='count-card'> */}
              <Box id= 'count-inside '  display="flex" flexDirection="column" alignItems="center">
          ...
          <div className='chart-container'>
            <b id = 'count-scoreprogress'  style={{marginLeft:"30%", fontSize:"20px"}}> Score Progress </b>
            <LearnerScoreProgressBarGraph/>
        ...
        <div className='d-flex ' id='recommend-container'>
          {filteredCourses.map((course, index) => (
            <div   id= "rec-course" key={index} >
             
              <Card  id= 'course-card' sx={{ backgroundColor: '#e6eefb' }} >
                <CardMedia
