  ...
  return (
    ...
    <Container>
      ...
      <Row className="mt-1">
        ...
        <Col md={12} xs={12} >
          <Card sx={{ display: 'flex', maxWidth: 1200, marginLeft: '20px', height: '180px', fontSize: '18px',border: '1px solid grey' }} className="mt-2">
            <CardMedia
      ...
      <Typography variant="h7" display="block"><FaHandPointRight style={{ fontSize: '20px', color: 'gray', marginRight: '10px' }} />
              ...
              <Typography variant="h7" display="block" className="mt-2"><FaHandPointRight style={{ fontSize: '20px', color: 'gray', marginRight: '10px' }} />
