    ...
    if (AttemptId && !isSubmitting) {
      ...
      dispatch(submitAttemptRequest(AttemptId))
        .then(() => {
          ...
          // document.exitFullscreen(); // Exit full screen mode after submitting
        ...
        <div className="review-answers-container">
          ...
          <div>
            <QuestionNavigationBar
              ...
              selectedOptions={data.questionResponses.reduce(
                (acc, response) => {
          ...
          <div className="review-answers-content">
                        ...
                        <input
                          ...
                          checked={
                            Array.isArray(response.selectedOptions)
                              ? response.selectedOptions.includes(option.option)
                              : response.selectedOptions === option.option
                          }
                          readOnly
            ...
            <div className="button-container">
              <button
                className="review-previous-button"
